 ...
 */
function to_do_list_admin_date_combo($variables) {
 ...
 */
function to_do_list_admin_preprocess_views_exposed_form(&$vars) {
  $wrap_button = false;
 ...
 */
function to_do_list_admin_views_bulk_operations_form_alter(&$form, &$form_state, $vbo) {
